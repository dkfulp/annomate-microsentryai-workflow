...
Handles the two wrinkles real widgets in this app have: a target that's
collapsed inside a _CollapsibleSection is expanded first, and a target inside
a QScrollArea is scrolled into view, before the overlay is drawn.
"""
